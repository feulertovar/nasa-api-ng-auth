...
@Component({
  selector: 'app-exodata-pod2',
  templateUrl: './exodata-pod2.component.html',
  styleUrls: ['./exodata-pod2.component.css']
})
export class ExodataPod2Component implements OnInit {
